# Data layer — Preventive Maintenance Assistant
...
Everything here is reproducible from scratch with the steps below — so anyone
...
```
synthetic_data/
├── README.md                     # ← this file (data-layer replication guide)
├── documents/                    # RAG source documents
│   ├── ATTRIBUTIONS.md           #   sources + licenses
│   ├── download_documents.py     #   fetches the 5 PDFs (they are git-ignored)
│   ├── user_manuals/             #   4 LulzBot FDM manuals (CC BY-SA 4.0)
│   └── safety_guidelines/        #   NIOSH safe-3D-printing guide (public domain)
